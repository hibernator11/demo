...
public class Summarizer {
  ...
  static {
    ...
    //props.setProperty("pos.model", "models/spanish-distsim.tagger");
  ...
  public Summarizer(Counter<String> dfCounter) {
    ...
    System.out.println("this.numDocuments:" + this.numDocuments);
  }
  ...
  private static final String DF_COUNTER_PATH = "/home/gcandela/df-counts.ser";
  ...
  public static void main(String[] args) throws IOException, ClassNotFoundException {
    ...
    String content = IOUtils.slurpFile("/home/gcandela/new.txt");
